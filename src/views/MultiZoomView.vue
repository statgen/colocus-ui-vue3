<template>
  <SidebarLayout>
    ...
    <ActionMenu v-if="menuState.visible"
      ...
      @move-panel-insert="(payload) => mzGridEventHandlers.onMovePlot({...payload, insert: true})"
      @move-panel-replace="(payload) => mzGridEventHandlers.onMovePlot({...payload, insert: false})"
